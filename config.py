...
LABEL_TEMPLATE = '<div style="position: absolute; color: {class_color}; top: {class_label_x}px; left: {class_label_y}px; font-size: 150%"><b>{label_symbol}-{class_label}</b></div>'
